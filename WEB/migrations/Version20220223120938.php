 ...
 */
final class Version20220223120938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin ADD id_rec INT DEFAULT NULL');
