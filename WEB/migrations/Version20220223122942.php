 ...
 */
final class Version20220223122942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin (id INT AUTO_INCREMENT NOT NULL, id_client INT DEFAULT NULL, id_agent_serv INT DEFAULT NULL, id_rec INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, numtel VARCHAR(8) NOT NULL, login VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_880E0D76AA08CB10 (login), INDEX IDX_880E0D76E173B1B8 (id_client), INDEX IDX_880E0D76BAAC2CEC (id_agent_serv), INDEX IDX_880E0D76FAA12276 (id_rec), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
