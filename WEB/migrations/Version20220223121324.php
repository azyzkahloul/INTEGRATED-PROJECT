 ...
 */
final class Version20220223121324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin ADD id_fourriere INT DEFAULT NULL, ADD id_rec INT DEFAULT NULL, DROP fourriere_id');
        $this->addSql('ALTER TABLE admin ADD CONSTRAINT FK_880E0D7613C53DB8 FOREIGN KEY (id_fourriere) REFERENCES fourriere (id_fourriere)');
        $this->addSql('ALTER TABLE admin ADD CONSTRAINT FK_880E0D76FAA12276 FOREIGN KEY (id_rec) REFERENCES reclamation (id_rec)');
        $this->addSql('CREATE INDEX IDX_880E0D7613C53DB8 ON admin (id_fourriere)');
        ...
        $this->addSql('ALTER TABLE fourriere CHANGE id id_fourriere INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE fourriere ADD PRIMARY KEY (id_fourriere)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fourriere MODIFY id_fourriere INT NOT NULL');
        $this->addSql('ALTER TABLE fourriere DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE fourriere CHANGE nomf nomf VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE id_fourriere id INT AUTO_INCREMENT NOT NULL');
