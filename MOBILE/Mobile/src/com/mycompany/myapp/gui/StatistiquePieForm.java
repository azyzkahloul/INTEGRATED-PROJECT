...
BaseForm form;
        ...
        RadioButton all = RadioButton.createToggle("Réponses", barGroup);
       
        all.setUIID("SelectBar");
        RadioButton popular = RadioButton.createToggle("Reclamations", barGroup);
        popular.setUIID("SelectBar");
        RadioButton feedback = RadioButton.createToggle("Réponses", barGroup);
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutAdminForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        String []messages = {
            "Statistique : Réponses % Réclamations"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Reclamations",prcntRec);
        series.add("Réponses",prcntFeed);
