...
public class ListClientForm extends Form {
    ...
    public ListClientForm(Form previous) {
        setTitle("List Client");
           ...
           for(Client a:list){
               TableModel model=new DefaultTableModel(new String[] {"nom","prenom","numtel","voitma","instamonnai","login","password","statut"},
                       new Object[][]{
                   {a.getNom(),a.getPrenom(),a.getNumtel(),a.getVoitmat(),a.getInstamonnaie(),a.getLogin(),a.getPassword(),a.getStatut()}
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce client ?","Oui","Annuler")) {
                ...
                if(ServiceClient.getInstance().deleteClient(a.getId())) {
